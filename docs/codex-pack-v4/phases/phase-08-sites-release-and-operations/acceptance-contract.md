# Phase 08 Acceptance Contract — Sites Release and Operations

## PASS Conditions


- reviewed version is saved before Deploy.
- family preview is completed and blockers are closed.
- user explicitly approves Deploy.
- Kakao production domain works.
- incognito production smoke passes.
- GitHub Actions production ingest updates the snapshot idempotently.
- rollback and scheduler runbooks are complete.
...
EVIDENCE: docs/evidence/phase-08/phase-receipt.json
BLOCKERS: none or exact blockers
NEXT_ALLOWED_PHASE: none or none
```
