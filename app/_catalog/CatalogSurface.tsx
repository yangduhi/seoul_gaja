        ...
        <section className={styles.main} aria-label="서울 지도와 추천" data-selected-area-code={selectedRow?.areaCode ?? "none"}>
          <GlassPanel depth="content" className={styles.mapPane} aria-label="서울 한눈에 보기">
            ...
            <div className={styles.mapContent}>
              <div className={styles.mapHeading}><div><p className={styles.eyebrow}>LIVE MAP</p><h2>서울 한눈에 보기</h2><p>공식 장소 목록과 같은 선택 상태를 공유합니다.</p></div><span className={styles.caption}>{status === "READY" ? "공식 데이터 반영" : "공식 데이터 연결 대기"}</span></div>
